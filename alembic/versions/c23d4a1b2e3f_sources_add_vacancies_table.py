...
Adds the ``vacancies`` table that stores canonical job vacancy data
ingested from external sources (hh.ru, Habr Career, Telegram, etc.).
The ``(source, source_id)`` pair is unique to prevent duplicates.
"""
