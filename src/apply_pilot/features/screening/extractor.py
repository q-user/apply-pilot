...
* :class:`ScreeningQuestionExtractor` — the Protocol the
  :class:`~apply_pilot.features.sources.service.SourceService` depends
...
The :class:`~apply_pilot.features.screening.models.ScreeningQuestion`
...
from apply_pilot.features.screening.repository import ScreeningQuestionRepository
...
class ScreeningQuestionExtractor(Protocol):
    ...
    The :class:`~apply_pilot.features.sources.service.SourceService`
