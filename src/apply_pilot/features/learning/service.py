...
:mod:`apply_pilot.features.learning.repository`. Keeping the value
...
from apply_pilot.features.learning.models import LearningSignal
from apply_pilot.features.learning.repository import LearningSignalRepository

_LOGGER = logging.getLogger("apply_pilot.features.learning.service")
...
class LearningSignalsService:
    ...
    :class:`apply_pilot.features.audit.service.AuditService`.
    """
