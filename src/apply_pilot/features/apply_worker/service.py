...
* :meth:`fail` — record a failed run. ``retryable=True`` parks the row
  ...
  injected :class:`~apply_pilot.features.apply_worker.retry.RetryPolicy`;
...
from apply_pilot.features.apply_worker.notifications import ApplyNotifier
...
from apply_pilot.shared.errors import ConflictError, NotFoundError
...
class ApplyJobService:
    ...
    def fail(
        ...
        *,
        ...
        :class:`~apply_pilot.features.apply_worker.retry.RetryPolicy` so
