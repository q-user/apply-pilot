...
It subclasses :class:`~apply_pilot.runtime.process.BaseProcess` so it
...
(:class:`~apply_pilot.features.telegram.process.TelegramBotProcess`,
:class:`~apply_pilot.features.apply_worker.runtime.ApplyWorkerProcess`)
...
_LOG_PREFIX = "apply_pilot.features.telegram_channels.scanner."
