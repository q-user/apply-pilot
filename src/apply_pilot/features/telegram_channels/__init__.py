...
:class:`~apply_pilot.features.sources.models.Vacancy` model, and pushes
...
from apply_pilot.features.telegram_channels.adapter import TelegramChannelSourceAdapter
from apply_pilot.features.telegram_channels.classifier import TelegramChannelClassifier
from apply_pilot.features.telegram_channels.client import (
    InMemoryTelegramChannelClient,
    TelegramChannelClient,
    TelegramChannelMessage,
)
from apply_pilot.features.telegram_channels.config import (
...
from apply_pilot.features.telegram_channels.scanner import TelegramChannelScanner
