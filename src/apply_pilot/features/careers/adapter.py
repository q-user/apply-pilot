...
:class:`~apply_pilot.features.sources.adapter.AdapterRegistry` can
...
from apply_pilot.features.careers.config import CareersPageSite
from apply_pilot.features.careers.parser import parse_payload
