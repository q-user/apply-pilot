...
:class:`~apply_pilot.features.sources.adapter.AdapterRegistry` under
...
* :class:`CareersPageSite` / :class:`CareersPageConfig` — value
  objects loaded from :mod:`apply_pilot.config` (env-driven).
...
from apply_pilot.features.careers.adapter import (
...
from apply_pilot.features.careers.config import (
