...
from apply_pilot.features.audit.repository import AuditLogRepository, SqlAuditLogRepository

_LOGGER = logging.getLogger("apply_pilot.features.audit.service")
