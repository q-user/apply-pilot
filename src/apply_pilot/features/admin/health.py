...
from apply_pilot.db import engine
from apply_pilot.runtime import create_redis_client

_LOGGER = logging.getLogger("apply_pilot.features.admin.health")
...
class HealthStatus(StrEnum):
    ...
    Using :class:`enum.StrEnum` so the value is JSON-serializable
...
def _default_settings() -> Settings:
    ...
    consistent with :func:`apply_pilot.config.get_settings`.
    """
    from apply_pilot.config import get_settings
