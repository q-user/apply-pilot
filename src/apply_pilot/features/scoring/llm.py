...
from apply_pilot.features.scoring.prompts import (
    VACANCY_SCORING_PROMPT_VERSION,
    build_vacancy_scoring_prompt,
)
from apply_pilot.features.scoring.registry import PromptVersionRegistry
...
#: :mod:`apply_pilot.features.scoring.prompts`.
...
class ScoreResult:
    ...
    prompt_version:
        ...
        :data:`~apply_pilot.features.scoring.prompts.VACANCY_SCORING_PROMPT_VERSION`.
    confidence:
