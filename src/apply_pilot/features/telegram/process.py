...
_LOGGER = logging.getLogger("apply_pilot.features.telegram.process")
...
def main() -> int:
    ...
    Reads settings from the environment via :func:`apply_pilot.config.get_telegram_settings`,
    ...
    from apply_pilot.config import get_telegram_settings
