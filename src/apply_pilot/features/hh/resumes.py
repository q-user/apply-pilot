...
* :class:`HhHttpResumesClient` — the production client backed by
  ...
  :class:`~apply_pilot.features.hh.service.HHCredentialService`.
...
class HhResumeLink(Base):
    """A link between a local :class:`~apply_pilot.features.users.models.User`
    ...
    :class:`~apply_pilot.features.resumes.models.Resume` row) is out of
