...
client (e.g. :class:`~apply_pilot.features.hh.search.HHVacancySearchClient`)
to the canonical ingest pipeline
(:class:`~apply_pilot.features.sources.service.SourceService`). It is the
...
:class:`~apply_pilot.features.hh.search.HHVacancySearchClient`-shaped
