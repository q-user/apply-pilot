...
:class:`~apply_pilot.features.screening.extractor.ScreeningQuestionExtractor`
...
(via an optional
:class:`~apply_pilot.features.source_metrics.service.SourceMetricsService`).
...
if TYPE_CHECKING:
    from apply_pilot.features.screening.extractor import ScreeningQuestionExtractor
