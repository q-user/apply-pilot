...
service. See :mod:`job_apply.features.writing_style_memory.summariser`
...
from job_apply.features.writing_style_memory.models import (
    StyleMemory,
    StyleMemoryEntry,
)
...
_LOGGER = logging.getLogger("job_apply.features.writing_style_memory.service")
