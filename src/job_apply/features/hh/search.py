...
mapping to :class:`~job_apply.features.sources.models.Vacancy` lives in
:class:`~job_apply.features.sources.normalizer.VacancyNormalizer`, which
keeps this module free of ORM coupling. The cross-source
:class:`VacancySearchService` in :mod:`job_apply.features.sources.search_service`
composes the two.
"""
...
class HHVacancySearchClient(Protocol):
    ...
    :meth:`~job_apply.features.sources.normalizer.VacancyNormalizer.normalize_hh`
