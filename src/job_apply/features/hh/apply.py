...
:class:`~job_apply.features.apply_worker.runtime.ApplyAdapter` Protocol
...
failures (see :mod:`job_apply.features.apply_worker.retry`). hh.ru
...
:mod:`job_apply.app` builds the adapter with a payload builder).
"""
