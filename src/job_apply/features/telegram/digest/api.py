...
from job_apply.config import TelegramSettings, get_telegram_settings
...
from job_apply.features.telegram.digest import DigestSender, StatsService
...
_LOGGER = logging.getLogger("job_apply.features.telegram.digest.api")
