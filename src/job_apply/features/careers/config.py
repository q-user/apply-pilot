...
var (``APP_CAREERS_PAGES`` by default — wired in :mod:`job_apply.config`).
...
The dataclasses live here (not in :mod:`job_apply.config`) on
...
from job_apply.features.careers.parser import CareersParserKind
