...
their own modules (:mod:`job_apply.features.scoring_ab.service` and
:mod:`job_apply.features.scoring_ab.api`); the schema is split this
...
class ScoringExperiment:
    ...
    :mod:`job_apply.features.scoring_ab.models` exist only as a
    persistence detail.
