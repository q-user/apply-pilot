...
style — see ``src/job_apply/features/telegram/digest/api.py``), not a
...
from job_apply.features.learning.repository import SqlLearningSignalRepository
from job_apply.features.learning.schemas import (
    LearningSignalRead,
    learning_signal_to_read,
)
from job_apply.features.learning.service import LearningSignalsService

_LOGGER = logging.getLogger("job_apply.features.learning.api")
