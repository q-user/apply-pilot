...
:mod:`job_apply.features.learning.service` for convenience.
"""
...
from job_apply.features.learning.models import LearningSignal, LearningSignalRow

_LOGGER = logging.getLogger("job_apply.features.learning.repository")
