...
* :class:`ScreeningQuestion` — a question a job application asks the
  ...
  attached to a :class:`~job_apply.features.sources.models.Vacancy`
...
* :class:`ScreeningQuestionAnswer` — the LLM-suggested answer for a
  ...
  by the service in
  :mod:`job_apply.features.screening.service`).
...
class ScreeningQuestionAnswer(Base):
    ...
    :meth:`~job_apply.features.screening.service.ScreeningService.generate_answer`
