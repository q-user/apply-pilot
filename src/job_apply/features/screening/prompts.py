...
* :data:`SCREENING_ANSWER_PROMPT_VERSION` — the version stamp applied
  to :class:`~job_apply.features.screening.models.ScreeningQuestionAnswer.prompt_version`.
...
#: :class:`~job_apply.features.screening.models.ScreeningQuestionAnswer`
#: produced by :class:`~job_apply.features.screening.service.ScreeningService`.
