...
* :data:`VACANCY_SCORING_PROMPT_VERSION` — the version stamp applied
  to :class:`~job_apply.features.scoring.llm.ScoreResult.prompt_version`.
...
#: by :class:`~job_apply.features.scoring.llm.LLMScorer`. Form follows
...
#: in a strict JSON shape that :func:`~job_apply.features.scoring.llm.parse_score_response`
